...
class HAAIUsageCard extends HTMLElement {
  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = `<style>
      :host{display:block;--good:var(--dashboard-success,#54d9aa);--warning:var(--dashboard-warning,#ffbd59);--danger:var(--dashboard-danger,#ff667a);--muted:var(--dashboard-icon-muted,#8390a2);--accent:var(--dashboard-accent,#62b5ff);--edge:var(--dashboard-border-neutral,rgba(255,255,255,.11))}*{box-sizing:border-box}ha-card{overflow:hidden;border-radius:26px;background:linear-gradient(145deg,color-mix(in srgb,var(--surface,var(--ha-card-background)) 96%,var(--accent) 4%),var(--surface,var(--ha-card-background)));color:var(--primary-text-color);box-shadow:var(--ha-card-box-shadow)}.shell{position:relative;padding:24px;isolation:isolate}.ambient{position:absolute;inset:-20%;z-index:-1;pointer-events:none;background:radial-gradient(circle at 8% 0,color-mix(in srgb,var(--accent) 15%,transparent),transparent 25%),radial-gradient(circle at 95% 8%,color-mix(in srgb,var(--good) 11%,transparent),transparent 28%)}
      header{display:flex;align-items:flex-start;justify-content:space-between;gap:20px;margin-bottom:18px}.eyebrow{display:flex;align-items:center;gap:8px;color:var(--accent);font-size:10px;font-weight:800;letter-spacing:.17em;text-transform:uppercase}.eyebrow i{width:7px;height:7px;border-radius:50%;background:currentColor;box-shadow:0 0 12px currentColor;animation:pulse 2.4s ease-in-out infinite}h2{margin:6px 0 3px;font-size:clamp(24px,3vw,34px);letter-spacing:-.045em}.subtitle{color:var(--secondary-text-color);font-size:12px}.overview{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end}.overview>div{min-width:92px;padding:10px 13px;border:1px solid var(--edge);border-radius:14px;background:color-mix(in srgb,var(--surface,var(--ha-card-background)) 88%,transparent)}.overview span{display:block;color:var(--secondary-text-color);font-size:8px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.overview strong{display:block;margin-top:3px;font-size:17px}.overview .${globalTone} strong{color:var(--${globalTone})}
      .accounts{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,290px),1fr));gap:12px}.account{--tone:var(--muted);position:relative;min-width:0;padding:16px;border:1px solid color-mix(in srgb,var(--tone) 28%,var(--edge));border-radius:20px;background:linear-gradient(150deg,color-mix(in srgb,var(--tone) 7%,transparent),rgba(0,0,0,.045));box-shadow:0 10px 28px rgba(0,0,0,.09);animation:cardIn .35s both;animation-delay:var(--delay)}.account.good,.window.good{--tone:var(--good)}.account.warning,.window.warning{--tone:var(--warning)}.account.danger,.window.danger{--tone:var(--danger)}.account.muted,.window.muted{--tone:var(--muted)}.account-head{display:flex;align-items:center;justify-content:space-between;gap:10px}.identity{display:flex;align-items:center;min-width:0;gap:10px}.service-icon{display:grid;place-items:center;flex:0 0 42px;width:42px;height:42px;border:1px solid color-mix(in srgb,var(--tone) 36%,transparent);border-radius:13px;background:color-mix(in srgb,var(--tone) 13%,transparent);color:var(--tone)}.service-icon ha-icon{width:23px;height:23px;--mdc-icon-size:23px}.identity h3{overflow:hidden;margin:0;font-size:16px;text-overflow:ellipsis;white-space:nowrap}.identity div>span{display:block;margin-top:3px;color:var(--secondary-text-color);font-size:9px}.connection{display:flex;align-items:center;gap:6px;color:var(--tone);font-size:9px;font-weight:800;text-transform:uppercase}.connection i{width:7px;height:7px;border-radius:50%;background:currentColor;box-shadow:0 0 9px currentColor}.plan-row{display:grid;grid-template-columns:auto auto 1fr;align-items:center;gap:6px;margin:14px 0 11px;padding:9px 10px;border:1px solid var(--edge);border-radius:11px;background:rgba(0,0,0,.045);font-size:9px}.plan-row>span:first-child{color:var(--secondary-text-color);text-transform:uppercase}.plan-row>strong{text-transform:capitalize}.capacity{justify-self:end;color:var(--tone);font-weight:800}
      .windows{display:grid;gap:8px}.window{--tone:var(--muted);display:grid;grid-template-columns:58px 1fr;align-items:center;gap:11px;padding:10px;border:1px solid var(--edge);border-radius:13px;background:rgba(0,0,0,.035)}.ring{position:relative;width:52px;height:52px}.ring svg{width:100%;height:100%;transform:rotate(-90deg)}.ring circle{fill:none;stroke-width:4}.ring .track{stroke:color-mix(in srgb,var(--secondary-text-color) 18%,transparent)}.ring .progress{stroke:var(--tone);stroke-linecap:round;stroke-dasharray:113.1;stroke-dashoffset:calc(113.1 - 1.131 * var(--value));filter:drop-shadow(0 0 4px color-mix(in srgb,var(--tone) 55%,transparent));transition:stroke-dashoffset .8s ease}.ring>strong{position:absolute;inset:0;display:grid;place-items:center;font-size:14px}.ring small{margin-left:1px;font-size:7px}.window-copy{min-width:0}.window-copy>span{display:flex;align-items:center;gap:5px;color:var(--secondary-text-color);font-size:8px;font-weight:800;text-transform:uppercase}.window-copy ha-icon{width:14px;height:14px;--mdc-icon-size:14px;color:var(--tone)}.window-copy>strong{display:block;margin:4px 0 7px;font-size:10px}.bar{height:4px;overflow:hidden;border-radius:5px;background:color-mix(in srgb,var(--secondary-text-color) 16%,transparent)}.bar i{display:block;width:calc(var(--value) * 1%);height:100%;border-radius:inherit;background:linear-gradient(90deg,color-mix(in srgb,var(--tone) 60%,var(--accent)),var(--tone));box-shadow:0 0 7px var(--tone);transition:width .8s ease}
